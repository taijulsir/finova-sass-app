    ...
    return (
      <button
        ...
        className={cn(
          ...
          "bg-secondary text-secondary-foreground border border-border text-sm font-medium transition-all",
          "hover:bg-accent hover:text-accent-foreground hover:scale-[1.01] active:scale-[0.99]",
